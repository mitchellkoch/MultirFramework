...
public class ExtendedNERArgumentIdentification implements
	...
	private static ExtendedNERArgumentIdentification instance = null;

	private ExtendedNERArgumentIdentification() {
	}

	public static ExtendedNERArgumentIdentification getInstance() {
		if (instance == null)
			instance = new ExtendedNERArgumentIdentification();
		return instance;
	}
